				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" action="/postloginsiswa" method="POST">
								{{csrf_field()}}
								<div class="form-group">
									<label for="signin-email" class="control-label sr-only">Email</label>
									<input name="nis"  type="text" class="form-control" id="signin-email" value="" placeholder="Username">
								</div>
								<div class="form-group">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Welcome To Website Raport Online</h1>
							<p>SD Negeri Pagak</p>
						</div>
					</div>
