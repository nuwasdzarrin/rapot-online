				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
					  ...
					  <div class="form-group{{$errors->has('tgl_lahir') ? ' has-error' : ''}}"">
					    ...
					    <input name="tgl_lahir" type="tgl_lahir" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="YY-MM-DD" value="{{old('tgl_lahir')}}">
				    ...
				    <textarea name="alamat" class="form-control" id="exampleFormControlTextarea1" rows="3">{{old('alamat')}}</textarea>
				     @if($errors->has('alamat'))
					   ...
					   <div class="form-group{{$errors->has('username_siswa') ? ' has-error' : ''}}"">
					    <label for="exampleInputEmail1">Username</label>
					    <input name="username_siswa" type="username_siswa" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Username" value="{{old('username_siswa')}}">
					     @if($errors->has('username_siswa'))
					   <span class="help-block">{{$errors->first('username_siswa')}}</span>
					   @endif
					  </div>
					  <div class="form-group{{$errors->has('password') ? ' has-error' : ''}}"">
					   ...
					   <div class="form-group{{$errors->has('status_aktif_siswa') ? ' has-error' : ''}}"">
					  ...
					  <div class="form-group form-check">
					    @if($errors->has('status_aktif_siswa'))
					   <span class="help-block">{{$errors->first('status_aktif_siswa')}}</span>
					   @endif
					  </div>
